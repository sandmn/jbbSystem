...
class UserProfile(AbstractUser):
    ...
    estimate = models.CharField(choices=(("best", u"优"), ("good", u"良"), ("normal", u"中"), ("bad", u"差")),
                                max_length=10, default="")  # 教师授课能力评估
    satisfaction = models.CharField(choices=(("best", u"优"), ("good", u"良"), ("normal", u"中"), ("bad", u"差")),
                                max_length=10, default="")  # 用户满意度评估
